...
class UbicacionProveedorController extends Controller
{
    ...
    {
        return view('ubicaciones-proveedor.index');
    }
    ...
    public function create()
    {
        ...
        return view('ubicaciones-proveedor.create', compact('perfilesProveedores'));
    }
    ...
    public function edit($ubicaciones_proveedor)
    {
        ...
        return view('ubicaciones-proveedor.edit', compact('ubicacionProveedor', 'perfilesProveedores'));
    }
