...
class ProveedorEspecialidadController extends Controller
{
    ...
    {
        return view('admin.proveedor-especialidades.index');
    }

    public function create()
    {
        return view('admin.proveedor-especialidades.create', $this->formData());
    }
    ...
    public function edit($proveedor_especialidade)
    {
        ...
        return view('admin.proveedor-especialidades.edit', [
