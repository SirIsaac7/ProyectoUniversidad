<div class="tab-pane fade {{ $tabActivo === 'historial' ? 'show active' : '' }}" id="clienteHistorialTab" role="tabpanel">
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="card-title mb-0">Historial de solicitudes</h5>
            <span class="badge bg-info-subtle text-info">{{ $historiales->total() }} movimientos</span>
        </div>
        <div class="card-body">
                            ...
                            @foreach ($historialesVista as $historialVista)
                                <tr>
                                    <td>
                                        ...
                                        <small class="text-muted">{{ $historialVista['proveedor'] }}</small>
                                    </td>
                                    <td>
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted mb-0">Los cambios de tus solicitudes apareceran aqui.</p>
                </div>
            @endif
        </div>
    </div>
