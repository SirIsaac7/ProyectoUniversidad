...
<div class="mi-portafolio-dashboard">
    ...
    <div class="row g-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mi-portafolio-grid" id="miPortafolioGridActivos" data-portafolio-tab-panel="activos">
                        @forelse ($trabajosActivos as $trabajo)
                            @include('mi-perfil-proveedor.portafolio.partials.trabajo')
                        @empty
        ...
        <div class="col-xl-4">
            @can('gestionar portafolio proveedor')
                @include('mi-perfil-proveedor.portafolio.partials.create')

                @foreach ($trabajos as $trabajo)
                    @include('mi-perfil-proveedor.portafolio.partials.edit')
                @endforeach
            @endcan
