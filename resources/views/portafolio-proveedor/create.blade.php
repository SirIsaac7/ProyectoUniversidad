...
@section('title', 'Crear trabajo de portafolio')

@section('content')
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
            <h4 class="mb-sm-0">Crear trabajo de portafolio</h4>
...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">Formulario de trabajo realizado</h5>
    </div>

    <div class="card-body">
        <form class="needs-validation form-steps js-portafolio-wizard" data-require-images="true" novalidate method="POST" action="{{ route('portafolio-proveedor.store') }}" enctype="multipart/form-data" autocomplete="off">
            @csrf
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="portafolio-datos" role="tabpanel" aria-labelledby="portafolio-datos-tab">
                    <div class="mb-4">
                        ...
                        <p class="text-muted mb-0">Registra el proveedor y la informacion principal del trabajo realizado.</p>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="fecha_trabajo" id="fecha_trabajo" class="form-control @error('fecha_trabajo') is-invalid @enderror" value="{{ old('fecha_trabajo') }}" max="{{ now()->toDateString() }}">
                            @error('fecha_trabajo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="tab-pane fade" id="portafolio-imagenes" role="tabpanel" aria-labelledby="portafolio-imagenes-tab">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <div>
                            <h5 class="mb-1">Imagenes del trabajo</h5>
                            <p class="text-muted mb-0">Agrega evidencia visual del trabajo. La primera imagen es obligatoria.</p>
                        </div>
                    ...
                    @enderror
                    <div class="invalid-feedback js-imagenes-feedback mb-2">Debes seleccionar al menos una imagen del trabajo.</div>
                            ...
                            <div class="col-lg-6 js-portafolio-imagen-card">
                                <div class="border rounded p-3 h-100 portafolio-imagen-card">
                                    ...
                                    <input
                                        type="file"
                                        name="imagenes[]"
                                        class="form-control mt-3 js-portafolio-imagen-input @error('imagenes.' . $i) is-invalid @enderror"
                ...
                <div class="tab-pane fade" id="portafolio-revision" role="tabpanel" aria-labelledby="portafolio-revision-tab">
                    <div class="text-center py-4">
                        ...
                        <h5>Listo para guardar</h5>
                        <p class="text-muted mb-0">Verifica la informacion ingresada y guarda el trabajo en el portafolio del proveedor.</p>
                    </div>
