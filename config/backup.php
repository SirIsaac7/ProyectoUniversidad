...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'ProyectoIntegradorFinal'),
        ...
        'source' => [
            'files' => [
                ...
                'include' => array_values(array_filter([
                    is_dir(public_path('uploads')) ? public_path('uploads') : null,
                    is_dir(storage_path('app/public')) ? storage_path('app/public') : null,
                ])),
        ...
        'temporary_directory' => env(
            'BACKUP_TEMP_PATH',
            sys_get_temp_dir() . DIRECTORY_SEPARATOR . 'ProyectoIntegradorFinal-backup-temp'
        ),
